...
//                 "PICKUP_ARRIVED", "12345", "pickup"));

//         addMessage(build("Order delivered",
//                 "Please confirm delivery.",
//                 "DELIVERY_ARRIVED", "12344", "delivery"));
//     }

//     private MailboxMessage build(String subject, String content, String type, String orderId, String actionRequired) {
